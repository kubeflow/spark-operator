...
var _ = BeforeSuite(func() {
	...
	By("Installing spark operator helm chart")
	envSettings := cli.New()
	...
	logf.Log.Info("Installing helm chart spark-operator", "release name", ReleaseName, "release namespace", ReleaseNamespace, "chart", chartPath)
