...
Note that the mutating admission webhook is needed to use this feature. Please refer to the [Getting Started](../getting-started/index.md) on how to enable the mutating admission webhook.
...
[Getting Started](../getting-started/index.md) on how to enable the mutating admission webhook.
