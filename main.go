...
var (
	...
	sparkUIServiceAnnotationsStr = flag.String("spark-ui-service-annotations", "{}", "Annotations (as JSON string) for sparkui service.")
)
...
func main() {
	...
	sparkUIServiceAnnotations, err := util.GetAnnotationsFromJSONString(*sparkUIServiceAnnotationsStr)
	if err != nil {
	...
	applicationController := sparkapplication.NewController(
		crClient, kubeClient, crInformerFactory, podInformerFactory, metricConfig, *namespace, *ingressUrlFormat, sparkUIServiceAnnotations)
