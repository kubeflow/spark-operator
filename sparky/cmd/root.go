...
var rootCmd = &cobra.Command{
	Use:   "sparky",
	Short: "sparky is the command-line tool for working with the Spark Operator",
	Long: `sparky is the command-line tool for working with the Spark Operator. It supports creating, deleting and 
...
func init() {
	...
	rootCmd.AddCommand(createCmd, deleteCmd, eventsCommand, statusCmd, logCommand, listCmd, forwardCmd, generateCmd)
}
