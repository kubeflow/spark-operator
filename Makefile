...
manifests: controller-gen ## Generate CustomResourceDefinition, RBAC and WebhookConfiguration manifests.
	$(CONTROLLER_GEN) crd rbac:roleName=spark-operator webhook paths="./..." output:crd:artifacts:config=config/crd/bases
...
integration-test: clean ## Run go integration tests.
