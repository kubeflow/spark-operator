...
class IoK8sApiNetworkingV1IngressClassList(BaseModel):
    ...
    items: List[IoK8sApiNetworkingV1IngressClass] = Field(description="items is the list of IngressClasses.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiNetworkingV1IngressClassList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiNetworkingV1IngressClassList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [IoK8sApiNetworkingV1IngressClass.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
