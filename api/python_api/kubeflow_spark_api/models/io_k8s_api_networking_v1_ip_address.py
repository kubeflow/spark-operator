...
class IoK8sApiNetworkingV1IPAddress(BaseModel):
    ...
    spec: IoK8sApiNetworkingV1IPAddressSpec = Field(description="spec is the desired state of the IPAddress. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status")
