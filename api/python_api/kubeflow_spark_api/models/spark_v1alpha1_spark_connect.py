...
class SparkV1alpha1SparkConnect(BaseModel):
    """
    ...
    status: Optional[SparkV1alpha1SparkConnectStatus] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SparkV1alpha1SparkConnect from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SparkV1alpha1SparkConnect from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": SparkV1alpha1SparkConnectSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": SparkV1alpha1SparkConnectStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
