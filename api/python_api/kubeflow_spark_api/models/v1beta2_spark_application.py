...
class V1beta2SparkApplication(BaseModel):
    """
    ...
    spec: V1beta2SparkApplicationSpec
    status: Optional[V1beta2SparkApplicationStatus] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta2SparkApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta2SparkApplication from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": V1beta2SparkApplicationSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": V1beta2SparkApplicationStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
