...
class IoK8sApiCoreV1PodStatus(BaseModel):
    ...
    node_allocatable_resource_claim_statuses: Optional[List[IoK8sApiCoreV1NodeAllocatableResourceClaimStatus]] = Field(default=None, description="NodeAllocatableResourceClaimStatuses contains the status of node-allocatable resources that were allocated for this pod through DRA claims. This includes resources currently reported in v1.Node `status.allocatable` that are not extended resources (see https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/#extended-resources). Examples include \"cpu\", \"memory\", \"ephemeral-storage\", and hugepages.", alias="nodeAllocatableResourceClaimStatuses")
        ...
        if self.node_allocatable_resource_claim_statuses:
            for _item_node_allocatable_resource_claim_statuses in self.node_allocatable_resource_claim_statuses:
                if _item_node_allocatable_resource_claim_statuses:
                    _items.append(_item_node_allocatable_resource_claim_statuses.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "nodeAllocatableResourceClaimStatuses": [IoK8sApiCoreV1NodeAllocatableResourceClaimStatus.from_dict(_item) for _item in obj["nodeAllocatableResourceClaimStatuses"]] if obj.get("nodeAllocatableResourceClaimStatuses") is not None else None,
