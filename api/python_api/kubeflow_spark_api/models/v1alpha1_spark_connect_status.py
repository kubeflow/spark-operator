...
class V1alpha1SparkConnectStatus(BaseModel):
    """
    ...
    server: Optional[V1alpha1SparkConnectServerStatus] = Field(default=None, description="Server represents the current state of the SparkConnect server.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1alpha1SparkConnectStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1alpha1SparkConnectStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "server": V1alpha1SparkConnectServerStatus.from_dict(obj["server"]) if obj.get("server") is not None else None,
