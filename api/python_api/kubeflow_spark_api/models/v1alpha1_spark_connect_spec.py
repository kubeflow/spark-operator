...
class V1alpha1SparkConnectSpec(BaseModel):
    """
    SparkConnectSpec defines the desired state of SparkConnect.
    """ # noqa: E501
    dynamic_allocation: Optional[V1alpha1DynamicAllocation] = Field(default=None, description="DynamicAllocation configures dynamic allocation that becomes available for the Kubernetes scheduler backend since Spark 3.0.", alias="dynamicAllocation")
    executor: V1alpha1ExecutorSpec = Field(description="Executor is the Spark executor specification.")
    ...
    server: V1alpha1ServerSpec = Field(description="Server is the Spark connect server specification.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1alpha1SparkConnectSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1alpha1SparkConnectSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dynamicAllocation": V1alpha1DynamicAllocation.from_dict(obj["dynamicAllocation"]) if obj.get("dynamicAllocation") is not None else None,
            "executor": V1alpha1ExecutorSpec.from_dict(obj["executor"]) if obj.get("executor") is not None else None,
            "hadoopConf": obj.get("hadoopConf"),
            "image": obj.get("image"),
            "server": V1alpha1ServerSpec.from_dict(obj["server"]) if obj.get("server") is not None else None,
