...
class SparkoperatorV1beta2DriverSpec(BaseModel):
    """
    ...
    config_maps: Optional[List[SparkoperatorV1beta2NamePath]] = Field(default=None, description="ConfigMaps carries information of other ConfigMaps to add to the pod.", alias="configMaps")
    ...
    env_secret_key_refs: Optional[Dict[str, SparkoperatorV1beta2NameKey]] = Field(default=None, description="EnvSecretKeyRefs holds a mapping from environment variable names to SecretKeyRefs. Deprecated. Consider using `env` instead.", alias="envSecretKeyRefs")
    ...
    gpu: Optional[SparkoperatorV1beta2GPUSpec] = Field(default=None, description="GPU specifies GPU requirement for the pod.")
    ...
    java_options: Optional[StrictStr] = Field(default=None, description="JavaOptions is a string of extra JVM options to pass to the driver. For instance, GC settings or other logging.", alias="javaOptions")
    kubernetes_master: Optional[StrictStr] = Field(default=None, description="KubernetesMaster is the URL of the Kubernetes master used by the driver to manage executor pods and other Kubernetes resources. Default to https://kubernetes.default.svc.", alias="kubernetesMaster")
    ...
    ports: Optional[List[SparkoperatorV1beta2Port]] = Field(default=None, description="Ports settings for the pods, following the Kubernetes specifications.")
    ...
    secrets: Optional[List[SparkoperatorV1beta2SecretInfo]] = Field(default=None, description="Secrets carries information of secrets to add to the pod.")
    ...
    service_labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="ServiceLabels defines the labels to be added to the Kubernetes headless service used by executors to connect to the driver.", alias="serviceLabels")
    ...
    __properties: ClassVar[List[str]] = ["affinity", "annotations", "configMaps", "coreLimit", "coreRequest", "cores", "dnsConfig", "env", "envFrom", "envSecretKeyRefs", "envVars", "gpu", "hostAliases", "hostNetwork", "image", "initContainers", "javaOptions", "kubernetesMaster", "labels", "lifecycle", "memory", "memoryLimit", "memoryOverhead", "nodeSelector", "podName", "podSecurityContext", "ports", "priorityClassName", "schedulerName", "secrets", "securityContext", "serviceAccount", "serviceAnnotations", "serviceLabels", "shareProcessNamespace", "sidecars", "template", "terminationGracePeriodSeconds", "tolerations", "volumeMounts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SparkoperatorV1beta2DriverSpec from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SparkoperatorV1beta2DriverSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "configMaps": [SparkoperatorV1beta2NamePath.from_dict(_item) for _item in obj["configMaps"]] if obj.get("configMaps") is not None else None,
            ...
            "envSecretKeyRefs": dict(
                (_k, SparkoperatorV1beta2NameKey.from_dict(_v))
                for _k, _v in obj["envSecretKeyRefs"].items()
            )
            if obj.get("envSecretKeyRefs") is not None
            else None,
            "envVars": obj.get("envVars"),
            "gpu": SparkoperatorV1beta2GPUSpec.from_dict(obj["gpu"]) if obj.get("gpu") is not None else None,
            ...
            "kubernetesMaster": obj.get("kubernetesMaster"),
            ...
            "ports": [SparkoperatorV1beta2Port.from_dict(_item) for _item in obj["ports"]] if obj.get("ports") is not None else None,
            "priorityClassName": obj.get("priorityClassName"),
            "schedulerName": obj.get("schedulerName"),
            "secrets": [SparkoperatorV1beta2SecretInfo.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None,
