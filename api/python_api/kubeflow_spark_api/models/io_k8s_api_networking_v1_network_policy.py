...
class IoK8sApiNetworkingV1NetworkPolicy(BaseModel):
    ...
    spec: Optional[IoK8sApiNetworkingV1NetworkPolicySpec] = Field(default=None, description="spec represents the specification of the desired behavior for this NetworkPolicy.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiNetworkingV1NetworkPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiNetworkingV1NetworkPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoK8sApiNetworkingV1NetworkPolicySpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
