...
class V1beta2ScheduledSparkApplicationList(BaseModel):
    """
    ...
    items: List[V1beta2ScheduledSparkApplication]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1beta2ScheduledSparkApplicationList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1beta2ScheduledSparkApplicationList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1beta2ScheduledSparkApplication.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
