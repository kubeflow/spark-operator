...
class SparkV1alpha1SparkConnectSpec(BaseModel):
    """
    ...
    restart_config: Optional[SparkV1alpha1RestartConfig] = Field(default=None, description="RestartConfig defines the policy for operator-managed Spark Connect server pod restarts.", alias="restartConfig")
    ...
    __properties: ClassVar[List[str]] = ["dynamicAllocation", "executor", "hadoopConf", "image", "restartConfig", "server", "sparkConf", "sparkVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SparkV1alpha1SparkConnectSpec from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of restart_config
        if self.restart_config:
            _dict['restartConfig'] = self.restart_config.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SparkV1alpha1SparkConnectSpec from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "image": obj.get("image"),
            "restartConfig": SparkV1alpha1RestartConfig.from_dict(obj["restartConfig"]) if obj.get("restartConfig") is not None else None,
