...
class SparkoperatorV1beta2SparkApplicationStatus(BaseModel):
    """
    SparkApplicationStatus defines the observed state of SparkApplication
    """ # noqa: E501
    application_state: Optional[SparkoperatorV1beta2ApplicationState] = Field(default=None, description="AppState tells the overall application state.", alias="applicationState")
    driver_info: SparkoperatorV1beta2DriverInfo = Field(description="DriverInfo has information about the driver.", alias="driverInfo")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SparkoperatorV1beta2SparkApplicationStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SparkoperatorV1beta2SparkApplicationStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "applicationState": SparkoperatorV1beta2ApplicationState.from_dict(obj["applicationState"]) if obj.get("applicationState") is not None else None,
            "driverInfo": SparkoperatorV1beta2DriverInfo.from_dict(obj["driverInfo"]) if obj.get("driverInfo") is not None else None,
