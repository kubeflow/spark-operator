...
class IoK8sApiNetworkingV1NetworkPolicyList(BaseModel):
    ...
    items: List[IoK8sApiNetworkingV1NetworkPolicy] = Field(description="items is a list of schema objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IoK8sApiNetworkingV1NetworkPolicyList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IoK8sApiNetworkingV1NetworkPolicyList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [IoK8sApiNetworkingV1NetworkPolicy.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
