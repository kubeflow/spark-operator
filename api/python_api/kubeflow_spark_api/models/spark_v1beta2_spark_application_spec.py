...
class SparkV1beta2SparkApplicationSpec(BaseModel):
    ...
    managed_by: Optional[StrictStr] = Field(default=None, description="ManagedBy indicates the controller managing this SparkApplication. Set to \"sparkoperator.k8s.io/spark-operator\" for the built-in operator (default behavior when field is omitted) or \"kueue.x-k8s.io/multikueue\" to delegate reconciliation to MultiKueue. The field is immutable once set.", alias="managedBy")
