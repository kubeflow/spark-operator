...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MutatingLabelKeyMatchCondition) DeepCopyInto(out *MutatingLabelKeyMatchCondition) {
	*out = *in
	if in.Fixed != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MutatingLabelKeyMatchCondition.
func (in *MutatingLabelKeyMatchCondition) DeepCopy() *MutatingLabelKeyMatchCondition {
	if in == nil {
		return nil
	}
	out := new(MutatingLabelKeyMatchCondition)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SparkApplicationLabelsMutationSpec) DeepCopyInto(out *SparkApplicationLabelsMutationSpec) {
	*out = *in
	if in.LabelKeyMatches != nil {
		in, out := &in.LabelKeyMatches, &out.LabelKeyMatches
		*out = make([]MutatingLabelKeyMatchCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SparkApplicationLabelsMutationSpec.
func (in *SparkApplicationLabelsMutationSpec) DeepCopy() *SparkApplicationLabelsMutationSpec {
	if in == nil {
		return nil
	}
	out := new(SparkApplicationLabelsMutationSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SparkPodSpec) DeepCopyInto(out *SparkPodSpec) {
	*out = *in
	...
	if in.SparkApplicationLabelsMutation != nil {
		in, out := &in.SparkApplicationLabelsMutation, &out.SparkApplicationLabelsMutation
		*out = new(SparkApplicationLabelsMutationSpec)
		(*in).DeepCopyInto(*out)
	}
}
