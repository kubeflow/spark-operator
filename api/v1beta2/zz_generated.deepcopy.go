...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RecoveryPolicy) DeepCopyInto(out *RecoveryPolicy) {
	*out = *in
	...
	if in.MaxSnapshotAge != nil {
		in, out := &in.MaxSnapshotAge, &out.MaxSnapshotAge
		*out = new(metav1.Duration)
		**out = **in
	}
	if in.SnapshotMaxSizeBytes != nil {
		in, out := &in.SnapshotMaxSizeBytes, &out.SnapshotMaxSizeBytes
		*out = new(int64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RecoveryPolicy.
func (in *RecoveryPolicy) DeepCopy() *RecoveryPolicy {
	if in == nil {
		return nil
	}
	out := new(RecoveryPolicy)
...
func (in *RecoveryStatus) DeepCopyInto(out *RecoveryStatus) {
	*out = *in
	if in.RestoredFromEpoch != nil {
		in, out := &in.RestoredFromEpoch, &out.RestoredFromEpoch
		*out = new(int64)
		**out = **in
	}
	in.LastSnapshotTime.DeepCopyInto(&out.LastSnapshotTime)
}
...
func (in *SparkApplicationSpec) DeepCopyInto(out *SparkApplicationSpec) {
	*out = *in
	...
	if in.DriverPodDisruptionBudget != nil {
		in, out := &in.DriverPodDisruptionBudget, &out.DriverPodDisruptionBudget
		*out = new(bool)
		**out = **in
	}
}
