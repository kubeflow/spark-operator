...
func schema_spark_operator_v2_api_v1alpha1_ServerSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/api/core/v1.PodTemplateSpec", "k8s.io/api/core/v1.Service"},
	}
}
...
func schema_spark_operator_v2_api_v1alpha1_SparkConnect(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectSpec", "github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_spark_operator_v2_api_v1alpha1_SparkConnectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnect", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_spark_operator_v2_api_v1alpha1_SparkConnectStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kubeflow/spark-operator/v2/api/v1alpha1.SparkConnectServerStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.Condition", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
