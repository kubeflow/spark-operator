...
func (d *SparkPodDefaulter) Default(ctx context.Context, obj runtime.Object) error {
	...
	logger.Info("Mutating Spark pod", "name", pod.Name, "namespace", namespace)
...
func addSparkConfigMap(pod *corev1.Pod, app *v1beta2.SparkApplication) error {
	...
	addConfigMapVolume(pod, *app.Spec.SparkConfigMap, common.SparkConfigMapVolumeName)
	addConfigMapVolumeMount(pod, common.SparkConfigMapVolumeName, common.DefaultSparkConfDir)
	addEnvironmentVariable(pod, common.EnvSparkConfDir, common.DefaultSparkConfDir)
	return nil
}
...
func addHadoopConfigMap(pod *corev1.Pod, app *v1beta2.SparkApplication) error {
	...
	addConfigMapVolume(pod, *app.Spec.HadoopConfigMap, common.HadoopConfigMapVolumeName)
	addConfigMapVolumeMount(pod, common.HadoopConfigMapVolumeName, common.DefaultHadoopConfDir)
	addEnvironmentVariable(pod, common.EnvHadoopConfDir, common.DefaultHadoopConfDir)
	return nil
}
