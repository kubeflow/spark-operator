...
func (r *ResourceQuotaEnforcer) AdmitSparkApplication(app crdv1beta2.SparkApplication) (string, error) {
...
func (r *ResourceQuotaEnforcer) AdmitScheduledSparkApplication(app crdv1beta2.ScheduledSparkApplication) (string, error) {
