...
func newResourceUsageWatcher(crdInformerFactory crdinformers.SharedInformerFactory, coreV1InformerFactory informers.SharedInformerFactory) Watcher {
...
func (r *Watcher) GetCurrentResourceUsage(namespace string) ResourceList {
...
func (r *Watcher) GetCurrentResourceUsageWithApplication(namespace, kind, name string) (namespaceResources, applicationResources ResourceList) {
	r.currentUsageLock.RLock()
	defer r.currentUsageLock.RUnlock()
	if resourceUsageInternal, present := r.currentUsageByNamespace[namespace]; present {
...
func (r *Watcher) unsafeSetResources(namespace, name string, resources ResourceList, resourceMap map[string]map[string]*ResourceList) {
...
func (r *Watcher) unsafeDeleteResources(namespace, name string, resourceMap map[string]map[string]*ResourceList) {
...
func (r *Watcher) setResources(typeName, namespace, name string, resources ResourceList, resourceMap map[string]map[string]*ResourceList) {
...
func (r *Watcher) deleteResources(_, namespace, name string, resourceMap map[string]map[string]*ResourceList) {
