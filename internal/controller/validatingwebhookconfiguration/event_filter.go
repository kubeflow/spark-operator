...
func (v *EventFilter) Create(event.CreateEvent) bool {
	return true
}

// Update implements predicate.Predicate.
func (v *EventFilter) Update(event.UpdateEvent) bool {
	return true
}

// Delete implements predicate.Predicate.
func (v *EventFilter) Delete(event.DeleteEvent) bool {
	return false
}

// Generic implements predicate.Predicate.
func (v *EventFilter) Generic(event.GenericEvent) bool {
	return true
}
