...
func NewReconciler(client client.Client, certProvider *cert.CertProvider, name string) *Reconciler {
	return &Reconciler{
		client:       client,
...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	logger.Info("Updating CA bundle of ValidatingWebhookConfiguration", "name", req.Name, "namespace", req.Namespace)
