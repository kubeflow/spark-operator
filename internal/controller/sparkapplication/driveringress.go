...
func (r *SparkApplicationReconciler) createDriverIngress(app *v1beta2.SparkApplication, driverIngressConfiguration *v1beta2.DriverIngressConfiguration, service SparkService, ingressURL *url.URL, ingressClassName string) (*SparkIngress, error) {
...
func (r *SparkApplicationReconciler) createDriverIngressV1(app *v1beta2.SparkApplication, service SparkService, ingressName string, ingressURL *url.URL, ingressClassName string) (*SparkIngress, error) {
...
func (r *SparkApplicationReconciler) createDriverIngressLegacy(app *v1beta2.SparkApplication, service SparkService, ingressName string, ingressURL *url.URL) (*SparkIngress, error) {
	ingressResourceAnnotations := util.GetWebUIIngressAnnotations(app)
...
func (r *SparkApplicationReconciler) createDriverIngressService(
...
func (r *SparkApplicationReconciler) createDriverIngressServiceFromConfiguration(
	app *v1beta2.SparkApplication,
