...
func TestSparkAppMetrics(t *testing.T) {
	...
	wg.Wait()
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppCount, app1), common.Epsilon)
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppSubmitCount, app1), common.Epsilon)
	assert.InEpsilon(t, float64(5), metrics.sparkAppRunningCount.Value(app1), common.Epsilon)
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppSuccessCount, app1), common.Epsilon)
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppFailureCount, app1), common.Epsilon)
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppFailedSubmissionCount, app1), common.Epsilon)
	assert.InEpsilon(t, float64(5), metrics.sparkAppExecutorRunningCount.Value(app1), common.Epsilon)
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppExecutorFailureCount, app1), common.Epsilon)
	assert.InEpsilon(t, float64(10), util.FetchCounterValue(metrics.sparkAppExecutorSuccessCount, app1), common.Epsilon)
}
