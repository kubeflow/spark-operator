...
func (r *SparkApplicationReconciler) createWebUIService(app *v1beta2.SparkApplication) (*SparkService, error) {
...
func (r *SparkApplicationReconciler) createWebUIIngress(app *v1beta2.SparkApplication, service SparkService, ingressURL *url.URL, ingressClassName string) (*SparkIngress, error) {
