...
import (
	...
	sparkoperator_k8s_io_v1beta1 "k8s.io/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1beta1"
	...
	v1beta1 "k8s.io/spark-on-k8s-operator/pkg/client/listers/sparkoperator.k8s.io/v1beta1"
)
...
func NewFilteredScheduledSparkApplicationInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&sparkoperator_k8s_io_v1beta1.ScheduledSparkApplication{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *scheduledSparkApplicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sparkoperator_k8s_io_v1beta1.ScheduledSparkApplication{}, f.defaultInformer)
}
