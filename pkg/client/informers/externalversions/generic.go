...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1beta2.SchemeGroupVersion.WithResource("sparkapplicationclasses"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Sparkoperator().V1beta2().SparkApplicationClasses().Informer()}, nil
