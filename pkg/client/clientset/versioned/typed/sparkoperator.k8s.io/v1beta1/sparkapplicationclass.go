...
type SparkApplicationClassInterface interface {
	Create(*v1beta1.SparkApplicationClass) (*v1beta1.SparkApplicationClass, error)
	Update(*v1beta1.SparkApplicationClass) (*v1beta1.SparkApplicationClass, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.SparkApplicationClass, error)
	List(opts v1.ListOptions) (*v1beta1.SparkApplicationClassList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SparkApplicationClass, err error)
...
func newSparkApplicationClasses(c *SparkoperatorV1beta1Client) *sparkApplicationClasses {
...
func (c *sparkApplicationClasses) Get(name string, options v1.GetOptions) (result *v1beta1.SparkApplicationClass, err error) {
	result = &v1beta1.SparkApplicationClass{}
	err = c.client.Get().
...
func (c *sparkApplicationClasses) List(opts v1.ListOptions) (result *v1beta1.SparkApplicationClassList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.SparkApplicationClassList{}
	err = c.client.Get().
		Resource("sparkapplicationclasses").
...
func (c *sparkApplicationClasses) Create(sparkApplicationClass *v1beta1.SparkApplicationClass) (result *v1beta1.SparkApplicationClass, err error) {
	result = &v1beta1.SparkApplicationClass{}
	err = c.client.Post().
		Resource("sparkapplicationclasses").
...
func (c *sparkApplicationClasses) Update(sparkApplicationClass *v1beta1.SparkApplicationClass) (result *v1beta1.SparkApplicationClass, err error) {
	result = &v1beta1.SparkApplicationClass{}
	err = c.client.Put().
		Resource("sparkapplicationclasses").
...
func (c *sparkApplicationClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.SparkApplicationClass, err error) {
	result = &v1beta1.SparkApplicationClass{}
