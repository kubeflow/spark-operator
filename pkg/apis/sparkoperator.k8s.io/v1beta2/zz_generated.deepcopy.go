...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExpositionConfiguration) DeepCopyInto(out *ExpositionConfiguration) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExpositionConfiguration.
func (in *ExpositionConfiguration) DeepCopy() *ExpositionConfiguration {
	if in == nil {
		return nil
	}
	out := new(ExpositionConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SparkApplicationSpec) DeepCopyInto(out *SparkApplicationSpec) {
	*out = *in
	...
	if in.ExpositionOptions != nil {
		in, out := &in.ExpositionOptions, &out.ExpositionOptions
		*out = new(ExpositionConfiguration)
		(*in).DeepCopyInto(*out)
	}
	return
