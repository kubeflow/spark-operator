...
| controller.securityContext | object | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALL"]},"fsGroup":185,"runAsNonRoot":true}` | Security context for controller containers. |
...
| webhook.securityContext | object | `{"allowPrivilegeEscalation":false,"capabilities":{"drop":["ALLL"]},"fsGroup":185,"runAsNonRoot":true}` | Security context for webhook containers. |
