...
![Version: 1.4.4](https://img.shields.io/badge/Version-1.4.4-informational?style=flat-square) ![AppVersion: v1beta2-1.6.2-3.5.0](https://img.shields.io/badge/AppVersion-v1beta2--1.6.2--3.5.0-informational?style=flat-square)
...
| readinessProbe | object | `{"failureThreshold":3,"initialDelaySeconds":5,"periodSeconds":10,"successThreshold":1,"timeoutSeconds":1}` | Only used if the webhook is enabled |
| readinessProbe.failureThreshold | int | `3` | Failed probes needed for the webhook to be considered not ready |
| readinessProbe.initialDelaySeconds | int | `5` | Seconds after start before probe begins |
| readinessProbe.periodSeconds | int | `10` | Interval between each probe in seconds |
| readinessProbe.successThreshold | int | `1` | Successful probes needed for the webhook to be considered ready |
| readinessProbe.timeoutSeconds | int | `1` | Seconds before the probe times out |
