...
func start() {
	...
	var metrics *sparkapplication.Metrics
	if enableMetrics {
		metrics = sparkapplication.NewMetrics(&util.MetricConfig{
	...
	var manager *batchscheduler.SchedulerManager
	if enableBatchScheduler {
		manager = batchscheduler.NewSchedulerManager()
	}
